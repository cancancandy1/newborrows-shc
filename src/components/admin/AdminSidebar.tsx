...
const navItems = [
  {
    href: '/equipment/admin/dashboard',
    label: 'แดชบอร์ด',
    icon: (
  ...
  {
    href: '/equipment/admin/equipment',
    label: 'จัดการอุปกรณ์',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <aside className="w-72 bg-gray-900 text-white flex flex-col min-h-screen">
      ...
      <div className="p-4 border-t border-gray-700">
        <Link
          href="/equipment/borrow/step1"
          className="hidden flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-400 hover:text-white hover:bg-gray-800 transition-all mb-2"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
